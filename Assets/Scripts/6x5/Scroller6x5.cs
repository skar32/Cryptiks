...
public class Scroller6x5 : MonoBehaviour, IBeginDragHandler, IEndDragHandler, IDragHandler
{
    ...
    public HighlightingManager6x5 highlightingScript;
    ...
    public void OnBeginDrag(PointerEventData eventData)
    {
        ...
        else if (vertical > horizontal) // if the other scroll rect should be scrolled vertically
        {
            ...
            if (xPos == -320) { // if col 1 should be scrolled
                ExecuteEvents.Execute<IBeginDragHandler> (OtherScrollRect1.gameObject, eventData, ExecuteEvents.beginDragHandler);
                //Debug.Log("col1");
                scroll1 = true;
            } else if (xPos == -160) { // if col 2 should be scrolled 
                ExecuteEvents.Execute<IBeginDragHandler> (OtherScrollRect2.gameObject, eventData, ExecuteEvents.beginDragHandler);
                //Debug.Log("col2");
                scroll2 = true;
            } else if (xPos == 0) { // if col 3 should be scrolled
                ExecuteEvents.Execute<IBeginDragHandler> (OtherScrollRect3.gameObject, eventData, ExecuteEvents.beginDragHandler);
                //Debug.Log("col3");
                scroll3 = true;
            } else if (xPos == 160) { // if col 4 should be scrolled
                ExecuteEvents.Execute<IBeginDragHandler> (OtherScrollRect4.gameObject, eventData, ExecuteEvents.beginDragHandler);
                //Debug.Log("col4");
                scroll4 = true;
            } else if (xPos == 320) { // if col 5 should be scrolled
                ExecuteEvents.Execute<IBeginDragHandler> (OtherScrollRect5.gameObject, eventData, ExecuteEvents.beginDragHandler);
                //Debug.Log("col5");
                scroll5 = true;
            }
    ...
    public void UpdateRowTiles() // once a mouse drag ends and a shift is made in the column grid, update the positions of the letters in the row grid underneath
    {
        ...
        results = Physics2D.OverlapCircleAll(new Vector2(Tile11.transform.position.x, Tile11.transform.position.y), 0.15f); // Tile11
        FindText(results, out rowTileText, out colTileText);
        rowTileText.text = colTileText.text;

        results = Physics2D.OverlapCircleAll(new Vector2(Tile12.transform.position.x, Tile12.transform.position.y), 0.15f); // Tile12
        FindText(results, out rowTileText, out colTileText);
        rowTileText.text = colTileText.text;

        results = Physics2D.OverlapCircleAll(new Vector2(Tile13.transform.position.x, Tile13.transform.position.y), 0.15f); // Tile13
        FindText(results, out rowTileText, out colTileText);
        rowTileText.text = colTileText.text;

        results = Physics2D.OverlapCircleAll(new Vector2(Tile14.transform.position.x, Tile14.transform.position.y), 0.15f); // Tile14
        FindText(results, out rowTileText, out colTileText);
        rowTileText.text = colTileText.text;

        results = Physics2D.OverlapCircleAll(new Vector2(Tile15.transform.position.x, Tile15.transform.position.y), 0.15f); // Tile15
        FindText(results, out rowTileText, out colTileText);
        rowTileText.text = colTileText.text;

        results = Physics2D.OverlapCircleAll(new Vector2(Tile21.transform.position.x, Tile21.transform.position.y), 0.15f); // Tile21
        FindText(results, out rowTileText, out colTileText);
        rowTileText.text = colTileText.text;

        results = Physics2D.OverlapCircleAll(new Vector2(Tile22.transform.position.x, Tile22.transform.position.y), 0.15f); // Tile22
        FindText(results, out rowTileText, out colTileText);
        rowTileText.text = colTileText.text;

        results = Physics2D.OverlapCircleAll(new Vector2(Tile23.transform.position.x, Tile23.transform.position.y), 0.15f); // Tile23
        FindText(results, out rowTileText, out colTileText);
        rowTileText.text = colTileText.text;

        results = Physics2D.OverlapCircleAll(new Vector2(Tile24.transform.position.x, Tile24.transform.position.y), 0.15f); // Tile24
        FindText(results, out rowTileText, out colTileText);
        rowTileText.text = colTileText.text;

        results = Physics2D.OverlapCircleAll(new Vector2(Tile25.transform.position.x, Tile25.transform.position.y), 0.15f); // Tile25
        FindText(results, out rowTileText, out colTileText);
        rowTileText.text = colTileText.text;

        results = Physics2D.OverlapCircleAll(new Vector2(Tile31.transform.position.x, Tile31.transform.position.y), 0.15f); // Tile31
        FindText(results, out rowTileText, out colTileText);
        rowTileText.text = colTileText.text;

        results = Physics2D.OverlapCircleAll(new Vector2(Tile32.transform.position.x, Tile32.transform.position.y), 0.15f); // Tile32
        FindText(results, out rowTileText, out colTileText);
        rowTileText.text = colTileText.text;

        results = Physics2D.OverlapCircleAll(new Vector2(Tile33.transform.position.x, Tile33.transform.position.y), 0.15f); // Tile33
        FindText(results, out rowTileText, out colTileText);
        rowTileText.text = colTileText.text;

        results = Physics2D.OverlapCircleAll(new Vector2(Tile34.transform.position.x, Tile34.transform.position.y), 0.15f); // Tile34
        FindText(results, out rowTileText, out colTileText);
        rowTileText.text = colTileText.text;

        results = Physics2D.OverlapCircleAll(new Vector2(Tile35.transform.position.x, Tile35.transform.position.y), 0.15f); // Tile35
        FindText(results, out rowTileText, out colTileText);
        rowTileText.text = colTileText.text;

        results = Physics2D.OverlapCircleAll(new Vector2(Tile41.transform.position.x, Tile41.transform.position.y), 0.15f); // Tile41
        FindText(results, out rowTileText, out colTileText);
        rowTileText.text = colTileText.text;

        results = Physics2D.OverlapCircleAll(new Vector2(Tile42.transform.position.x, Tile42.transform.position.y), 0.15f); // Tile42
        FindText(results, out rowTileText, out colTileText);
        rowTileText.text = colTileText.text;

        results = Physics2D.OverlapCircleAll(new Vector2(Tile43.transform.position.x, Tile43.transform.position.y), 0.15f); // Tile43
        FindText(results, out rowTileText, out colTileText);
        rowTileText.text = colTileText.text;

        results = Physics2D.OverlapCircleAll(new Vector2(Tile44.transform.position.x, Tile44.transform.position.y), 0.15f); // Tile44
        FindText(results, out rowTileText, out colTileText);
        rowTileText.text = colTileText.text;

        results = Physics2D.OverlapCircleAll(new Vector2(Tile45.transform.position.x, Tile45.transform.position.y), 0.15f); // Tile45
        FindText(results, out rowTileText, out colTileText);
        rowTileText.text = colTileText.text;

        results = Physics2D.OverlapCircleAll(new Vector2(Tile51.transform.position.x, Tile51.transform.position.y), 0.15f); // Tile51
        FindText(results, out rowTileText, out colTileText);
        rowTileText.text = colTileText.text;

        results = Physics2D.OverlapCircleAll(new Vector2(Tile52.transform.position.x, Tile52.transform.position.y), 0.15f); // Tile52
        FindText(results, out rowTileText, out colTileText);
        rowTileText.text = colTileText.text;

        results = Physics2D.OverlapCircleAll(new Vector2(Tile53.transform.position.x, Tile53.transform.position.y), 0.15f); // Tile53
        FindText(results, out rowTileText, out colTileText);
        rowTileText.text = colTileText.text;

        results = Physics2D.OverlapCircleAll(new Vector2(Tile54.transform.position.x, Tile54.transform.position.y), 0.15f); // Tile54
        FindText(results, out rowTileText, out colTileText);
        rowTileText.text = colTileText.text;

        results = Physics2D.OverlapCircleAll(new Vector2(Tile55.transform.position.x, Tile55.transform.position.y), 0.15f); // Tile55
        FindText(results, out rowTileText, out colTileText);
        rowTileText.text = colTileText.text;

        results = Physics2D.OverlapCircleAll(new Vector2(Tile61.transform.position.x, Tile61.transform.position.y), 0.15f); // Tile61
        FindText(results, out rowTileText, out colTileText);
        rowTileText.text = colTileText.text;

        results = Physics2D.OverlapCircleAll(new Vector2(Tile62.transform.position.x, Tile62.transform.position.y), 0.15f); // Tile62
        FindText(results, out rowTileText, out colTileText);
        rowTileText.text = colTileText.text;

        results = Physics2D.OverlapCircleAll(new Vector2(Tile63.transform.position.x, Tile63.transform.position.y), 0.15f); // Tile63
        FindText(results, out rowTileText, out colTileText);
        rowTileText.text = colTileText.text;

        results = Physics2D.OverlapCircleAll(new Vector2(Tile64.transform.position.x, Tile64.transform.position.y), 0.15f); // Tile64
        FindText(results, out rowTileText, out colTileText);
        rowTileText.text = colTileText.text;

        results = Physics2D.OverlapCircleAll(new Vector2(Tile65.transform.position.x, Tile65.transform.position.y), 0.15f); // Tile65
        FindText(results, out rowTileText, out colTileText);
        rowTileText.text = colTileText.text;
    }
