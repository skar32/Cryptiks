...
public class StageData6x6 : MonoBehaviour
{
    ...
    public void SaveData()
    {
        ...
        results = Physics2D.OverlapCircleAll(new Vector2(Tile16.transform.position.x, Tile16.transform.position.y), 0.3f); // Tile16
        ...
        results = Physics2D.OverlapCircleAll(new Vector2(Tile26.transform.position.x, Tile26.transform.position.y), 0.3f); // Tile26
        ...
        results = Physics2D.OverlapCircleAll(new Vector2(Tile36.transform.position.x, Tile36.transform.position.y), 0.3f); // Tile36
        ...
        results = Physics2D.OverlapCircleAll(new Vector2(Tile46.transform.position.x, Tile46.transform.position.y), 0.3f); // Tile46
        FindTiles(results, out rowTile24Text, out colTile24Text, out rowTile24, out colTile24);

        results = Physics2D.OverlapCircleAll(new Vector2(Tile51.transform.position.x, Tile51.transform.position.y), 0.3f); // Tile51
        FindTiles(results, out rowTile25Text, out colTile25Text, out rowTile25, out colTile25);

        results = Physics2D.OverlapCircleAll(new Vector2(Tile51.transform.position.x, Tile51.transform.position.y), 0.3f); // Tile51
        FindTiles(results, out rowTile25Text, out colTile25Text, out rowTile25, out colTile25);

        results = Physics2D.OverlapCircleAll(new Vector2(Tile52.transform.position.x, Tile52.transform.position.y), 0.3f); // Tile52
        FindTiles(results, out rowTile26Text, out colTile26Text, out rowTile26, out colTile26);

        results = Physics2D.OverlapCircleAll(new Vector2(Tile53.transform.position.x, Tile53.transform.position.y), 0.3f); // Tile53
        FindTiles(results, out rowTile27Text, out colTile27Text, out rowTile27, out colTile27);

        results = Physics2D.OverlapCircleAll(new Vector2(Tile54.transform.position.x, Tile54.transform.position.y), 0.3f); // Tile54
        FindTiles(results, out rowTile28Text, out colTile28Text, out rowTile28, out colTile28);

        results = Physics2D.OverlapCircleAll(new Vector2(Tile55.transform.position.x, Tile55.transform.position.y), 0.3f); // Tile55
        FindTiles(results, out rowTile29Text, out colTile29Text, out rowTile29, out colTile29);

        results = Physics2D.OverlapCircleAll(new Vector2(Tile56.transform.position.x, Tile56.transform.position.y), 0.3f); // Tile56
        FindTiles(results, out rowTile30Text, out colTile30Text, out rowTile30, out colTile30);

        results = Physics2D.OverlapCircleAll(new Vector2(Tile61.transform.position.x, Tile61.transform.position.y), 0.3f); // Tile61
        FindTiles(results, out rowTile31Text, out colTile31Text, out rowTile31, out colTile31);

        results = Physics2D.OverlapCircleAll(new Vector2(Tile62.transform.position.x, Tile62.transform.position.y), 0.3f); // Tile62
        FindTiles(results, out rowTile32Text, out colTile32Text, out rowTile32, out colTile32);

        results = Physics2D.OverlapCircleAll(new Vector2(Tile63.transform.position.x, Tile63.transform.position.y), 0.3f); // Tile63
        FindTiles(results, out rowTile33Text, out colTile33Text, out rowTile33, out colTile33);

        results = Physics2D.OverlapCircleAll(new Vector2(Tile64.transform.position.x, Tile64.transform.position.y), 0.3f); // Tile64
        FindTiles(results, out rowTile34Text, out colTile34Text, out rowTile34, out colTile34);

        results = Physics2D.OverlapCircleAll(new Vector2(Tile65.transform.position.x, Tile65.transform.position.y), 0.3f); // Tile65
        FindTiles(results, out rowTile35Text, out colTile35Text, out rowTile35, out colTile35);

        results = Physics2D.OverlapCircleAll(new Vector2(Tile66.transform.position.x, Tile66.transform.position.y), 0.3f); // Tile66
        FindTiles(results, out rowTile36Text, out colTile36Text, out rowTile36, out colTile36);

        TMP_Text[] tileTexts = new TMP_Text[] {colTile1Text, colTile2Text, colTile3Text, colTile4Text, colTile5Text, colTile6Text, colTile7Text, colTile8Text, colTile9Text, colTile10Text, colTile11Text, colTile12Text, colTile13Text, colTile14Text, colTile5Text, colTile16Text, colTile17Text, colTile18Text, colTile19Text, colTile20Text, colTile21Text, colTile22Text, colTile23Text, colTile24Text, colTile25Text, colTile26Text, colTile27Text, colTile28Text, colTile29Text, colTile30Text, colTile31Text, colTile32Text, colTile33Text, colTile34Text, colTile35Text, colTile36Text};
