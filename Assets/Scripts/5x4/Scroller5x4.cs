...
public class Scroller5x4 : MonoBehaviour, IBeginDragHandler, IEndDragHandler, IDragHandler
{
    ...
    public HighlightingManager5x4 highlightingScript;
        ...
        if (scrollOtherHorizontally) // if the other scroll rect should be scrolled horizontally
        {
            if (horizontal > vertical)
            {
                ...
                if (yPos == 240) { // if row 1 should be scrolled
                    ...
                    //Debug.Log("row3");
                    scroll3 = true;
                } else if (yPos == -240) { // if row 4 should be scrolled
