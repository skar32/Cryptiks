...
public class Scroller5x5 : MonoBehaviour, IBeginDragHandler, IEndDragHandler, IDragHandler
{
    public GameObject rows, columns;
    public ScrollRect OtherScrollRect1, OtherScrollRect2, OtherScrollRect3, OtherScrollRect4, OtherScrollRect5;
    public GameObject Tile11, Tile12, Tile13, Tile14, Tile15, Tile21, Tile22, Tile23, Tile24, Tile25, Tile31, Tile32, Tile33, Tile34, Tile35, Tile41, Tile42, Tile43, Tile44, Tile45, Tile51, Tile52, Tile53, Tile54, Tile55;
    ...
    private bool scroll1, scroll2, scroll3, scroll4, scroll5;
    public HighlightingManager5x5 highlightingScript;
    ...
    public void UpdateRowTiles() // once a mouse drag ends and a shift is made in the column grid, update the positions of the letters in the row grid underneath
    {
        ...
        results = Physics2D.OverlapCircleAll(new Vector2(Tile15.transform.position.x, Tile15.transform.position.y), 0.5f); // Tile15
        FindText(results, out rowTileText, out colTileText);
        rowTileText.text = colTileText.text;
        ...
        results = Physics2D.OverlapCircleAll(new Vector2(Tile25.transform.position.x, Tile25.transform.position.y), 0.5f); // Tile25
        FindText(results, out rowTileText, out colTileText);
        rowTileText.text = colTileText.text;
        ...
        results = Physics2D.OverlapCircleAll(new Vector2(Tile35.transform.position.x, Tile35.transform.position.y), 0.5f); // Tile35
        FindText(results, out rowTileText, out colTileText);
        rowTileText.text = colTileText.text;
        ...
        results = Physics2D.OverlapCircleAll(new Vector2(Tile45.transform.position.x, Tile45.transform.position.y), 0.5f); // Tile45
        FindText(results, out rowTileText, out colTileText);
        rowTileText.text = colTileText.text;

        results = Physics2D.OverlapCircleAll(new Vector2(Tile51.transform.position.x, Tile51.transform.position.y), 0.5f); // Tile51
        FindText(results, out rowTileText, out colTileText);
        rowTileText.text = colTileText.text;

        results = Physics2D.OverlapCircleAll(new Vector2(Tile52.transform.position.x, Tile52.transform.position.y), 0.5f); // Tile52
        FindText(results, out rowTileText, out colTileText);
        rowTileText.text = colTileText.text;

        results = Physics2D.OverlapCircleAll(new Vector2(Tile53.transform.position.x, Tile53.transform.position.y), 0.5f); // Tile53
        FindText(results, out rowTileText, out colTileText);
        rowTileText.text = colTileText.text;

        results = Physics2D.OverlapCircleAll(new Vector2(Tile54.transform.position.x, Tile54.transform.position.y), 0.5f); // Tile54
        FindText(results, out rowTileText, out colTileText);
        rowTileText.text = colTileText.text;

        results = Physics2D.OverlapCircleAll(new Vector2(Tile55.transform.position.x, Tile55.transform.position.y), 0.5f); // Tile55
        FindText(results, out rowTileText, out colTileText);
        rowTileText.text = colTileText.text;
    }
